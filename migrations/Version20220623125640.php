 ...
 */
final class Version20220623125640 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE categorie ADD parent_id INT DEFAULT NULL, DROP materialized_path');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE categorie ADD materialized_path VARCHAR(255) NOT NULL, DROP parent_id');
    }
}
